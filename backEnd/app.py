...
# Ensure the current directory (where this file lives) is on sys.path so
# top-level imports like `from main import app` succeed when running from
# the project directory or in varied runtime contexts.
